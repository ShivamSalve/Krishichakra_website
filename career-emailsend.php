...
$mail->addAddress('sales@procetechautomation.com');
$mail->addBCC('vikrant@weblinkservices.net');
...
$bodyContent .="<p><b>Education : ".$c_name."</b></p>";
$bodyContent .="<p><b>Phone : ".$phone."</b></p>";
$bodyContent .="<p><b>Email : ".$email."</b></p>";
$bodyContent .="<p><b>Experience In Year :".$productname."</b></p>";
$bodyContent .="<p><b>City Name :".$city."</b></p>";
$bodyContent .="<p><b>Message :".$message."</b></p>";

$mail->AddAttachment($_FILES['file']['tmp_name'], $_FILES['file']['name']);

$mail->Subject = 'Career Enquiry from Website (Krishichakra Foods Private Limited)';
